data:extend({
  ...
  },
  {
      ...
      flags = {"placeable-neutral", "player-creation"},
      minable = {mining_time = 1, result = "logistic-trading-chest-sell"},
      max_health = 100,
      corpse = "small-remnants",
      open_sound = { filename = "__base__/sound/metallic-chest-open.ogg", volume=0.65 },
      close_sound = { filename = "__base__/sound/metallic-chest-close.ogg", volume = 0.7 },
      ...
      picture =
      {
        filename = "__GalacticTrade__/graphics/trading-chest/logistic-trading-chest-sell.png",
        priority = "extra-high",
        width = 38,
        height = 32,
        shift = {0.1, 0}
  ...
  },
  {
      ...
      flags = {"placeable-neutral", "player-creation"},
      minable = {mining_time = 1, result = "logistic-trading-chest-buy"},
      max_health = 100,
      corpse = "small-remnants",
      open_sound = { filename = "__base__/sound/metallic-chest-open.ogg", volume=0.65 },
      close_sound = { filename = "__base__/sound/metallic-chest-close.ogg", volume = 0.7 },
      ...
      picture =
      {
        filename = "__GalacticTrade__/graphics/trading-chest/logistic-trading-chest-buy.png",
        priority = "extra-high",
        width = 38,
        height = 32,
        shift = {0.1, 0}
